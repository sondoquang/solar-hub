...
- Điều hướng carousel: nút Trước/Sau + dot indicators (click) + phím ←/→ + lăn chuột (throttle 350ms); badge "Đơn x/N". "Đánh dấu hoàn thành" áp dụng cho đơn đang xem, xong thì sang đơn kế (hết thì đóng).
