...
const MAP = {
  paid: { bg: "bg-green-50", text: "text-success", label: "Đã thanh toán" },
  pending: { bg: "bg-amber-50", text: "text-warning", label: "Chưa thanh toán" },
  authorized: { bg: "bg-amber-50", text: "text-warning", label: "Chờ thanh toán" },
  partially_paid: {
    bg: "bg-amber-50",
    text: "text-warning",
  ...
  voided: { bg: "bg-red-50", text: "text-danger", label: "Đã hủy thanh toán" },
};
