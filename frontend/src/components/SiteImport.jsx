...
export default function SiteImport({ onImport, pending, hostings = [] }) {
  ...
  return (
    <>
      <div className="flex items-center gap-2 rounded bg-white p-2.5 shadow-card">
        <span className="flex h-10 w-10 items-center justify-center rounded bg-green-50 text-success">
      ...
      <Modal open={open} onCancel={close} footer={null} destroyOnClose title="Import website từ Excel">
